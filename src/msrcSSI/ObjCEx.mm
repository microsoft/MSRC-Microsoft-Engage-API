...
int main(int argc, const char * argv[])
{
    ...
    NSString* path = @"https://api.msrc.microsoft.com/engagebeta/ssi";
    NSArray* array = @[
                         // Request parameters
                         @"entities=true",
                      ];
    ...
    [_request setValue:@"" forHTTPHeaderField:@"Ocp-Apim-Trace"];
    [_request setValue:@" *******************" forHTTPHeaderField:@"api-key"];
